...
5. **Normalization (within-sample)**. The popular toolkit **Seurat** normalises data with the `NormalizeData` command which uses a "global-scaling normalization method “LogNormalize” that normalizes the feature expression measurements for each cell by the total expression, multiplies this by a scale factor (10,000 by default), and log-transforms the result."

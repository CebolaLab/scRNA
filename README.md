...
1. **CellRanger count**: generate count matrices. Initial filtering to remove empty droplets. 
2. **Seurat**: Read data into R, create Seurat object, merge technical replicates
